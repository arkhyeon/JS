...
export default function Atr({ register, CustomForm }) {
    return (
        <>
            ...
            <CustomForm title="전송 방식">
                <GrayRadioButton id="Bind" label="Bind" reg={{ ...register("trans_method") }} defaultValue="bind" readOnly />
                <GrayRadioButton id="Bulk" label="Bulk" reg={{ ...register("trans_method") }} defaultValue="bulk" readOnly />
            </CustomForm>
            ...
            <CustomForm title="더블 쿼테이션">
                <GrayRadioButton id="dq_y" label="사용" reg={{ ...register("dq_yn") }} defaultValue="y" readOnly />
                <GrayRadioButton id="dq_n" label="사용안함" reg={{ ...register("dq_yn") }} defaultValue="n" readOnly />
            </CustomForm>
            ...
            <CustomForm title="마지막 컬럼구분자">
                <GrayRadioButton id="lastcol_y" label="적용" reg={{ ...register("last_col_yn") }} defaultValue="y" readOnly />
                <GrayRadioButton id="lastcol_n" label="적용안함" reg={{ ...register("last_col_yn") }} defaultValue="n" readOnly />
            </CustomForm>

            <CustomForm title="Multi Thread">
                <GrayRadioButton id="multi_thread_y" label="ON" reg={{ ...register("multi_thread") }} defaultValue="on" readOnly />
                <GrayRadioButton id="multi_thread_n" label="OFF" reg={{ ...register("multi_thread") }} defaultValue="off" readOnly />
            </CustomForm>
        </>
    );
}
