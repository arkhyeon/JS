    ...
    return (
        <>
            ...
            <CustomForm title="전송 방식">
                ...
                <GrayRadioButton id="Bulk" label="Bulk" reg={{ ...register("trans_method") }} defaultValue="bulk" />
            </CustomForm>
            ...
            <CustomForm title="추출 동시 작업 수">
                <Form.Control {...register("extract_num")} type="number" readOnly={true} />
            </CustomForm>

            <CustomForm title="로드 동시 작업 수">
                <Form.Control {...register("load_num")} type="number" readOnly={true} />
            </CustomForm>
    ...
    return (
        <>
            <CustomForm title="중복 제거">
                <GrayRadioButton id="skip_y" label="사용" reg={{ ...register("skip_yn") }} defaultValue="y" />
                <GrayRadioButton id="skip_n" label="사용안함" reg={{ ...register("skip_yn") }} defaultValue="n" />
            </CustomForm>
        </>
    );
};
    ...
    return (
        <>
            <CustomForm title="Size Mode">
                <GrayRadioButton id="size_mode_y" label="ON" reg={{ ...register("size_mode_yn", { disabled: true }) }} defaultValue="on" />
                <GrayRadioButton id="size_mode_n" label="OFF" reg={{ ...register("size_mode_yn", { disabled: true }) }} defaultValue="off" />
            </CustomForm>

            <CustomForm title="Convert Char">
                <GrayRadioButton id="convert_char_y" label="ON" reg={{ ...register("convert_char_yn") }} defaultValue="on" />
                <GrayRadioButton id="convert_char_n" label="OFF" reg={{ ...register("convert_char_yn") }} defaultValue="off" />
            </CustomForm>
            ...
            <CustomForm title="Hint Degree">
                <Form.Control {...register("hint_degree")} type="number" readOnly={true} />
            </CustomForm>
...
export const LoadORACLE = ({ register, CustomForm, transMethod }) => {
    return (
        <>
            ...
            <CustomForm title="중복 제거">
                <GrayRadioButton id="skip_y" label="사용" reg={{ ...register("skip_yn", { disabled: transMethod !== "bind" }) }} defaultValue="y" />
                <GrayRadioButton id="skip_n" label="사용안함" reg={{ ...register("skip_yn", { disabled: transMethod !== "bind" }) }} defaultValue="n" />
            </CustomForm>

            <CustomForm title="No Log">
                <GrayRadioButton id="no_log_y" label="사용" reg={{ ...register("no_log", { disabled: transMethod === "bind" }) }} defaultValue="y" />
                <GrayRadioButton id="no_log_n" label="사용안함" reg={{ ...register("no_log", { disabled: transMethod === "bind" }) }} defaultValue="n" />
            </CustomForm>

            <CustomForm title="병렬 모드">
                <GrayRadioButton id="parallel_y" label="사용" reg={{ ...register("parallel", { disabled: transMethod === "bind" }) }} defaultValue="y" />
                <GrayRadioButton id="parallel_n" label="사용안함" reg={{ ...register("parallel", { disabled: transMethod === "bind" }) }} defaultValue="n" />
            </CustomForm>

            <CustomForm title="Buffer Size(MB)">
                <Form.Control {...register("buffer_size", { disabled: transMethod === "bind" })} type="number" />
            </CustomForm>
        </>
    );
};
    ...
    return (
        <>
            ...
            <CustomForm title="Load Mode">
                <GrayRadioButton id="insert" label="Insert" reg={{ ...register("load_mode") }} defaultValue="insert" />
                <GrayRadioButton id="replace" label="Replace" reg={{ ...register("load_mode") }} defaultValue="replace" />
            </CustomForm>
            ...
            <CustomForm title="Load Option">
                <GrayRadioButton id="ignore" label="IGNORE" reg={{ ...register("load_opt") }} defaultValue="ignore" />
                <GrayRadioButton id="override" label="OVERRIDE" reg={{ ...register("load_opt") }} defaultValue="override" />
            </CustomForm>
        </>
    );
};
        ...
        <>
            {(dstTransType === IQ || dstTransType === VERTICA) && (
                <CustomForm title="원격 접속">
                    <GrayRadioButton id="remote_mode_y" label="ON" reg={{ ...register("remote_mode_yn") }} defaultValue="on" />
                    <GrayRadioButton id="remote_mode_n" label="OFF" reg={{ ...register("remote_mode_yn") }} defaultValue="off" />
                </CustomForm>
            )}
            ...
            {dstTransType === TERADATA && (
                <>
                    <CustomForm title="세션 옵션">
                        <Form.Control {...register("session_option")} type="number" />
                    </CustomForm>
                    ...
                    <CustomForm title="FASTLOAD 방식">
                        <GrayRadioButton id="fastload_y" label="ON" reg={{ ...register("fastload_yn") }} defaultValue="on" />
                        <GrayRadioButton id="fastload_n" label="OFF" reg={{ ...register("fastload_yn") }} defaultValue="off" />
                    </CustomForm>
